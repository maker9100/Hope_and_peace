...
- SOLO ELIMINATION 삭제, **LOCALIZED EXPLOSION** 추가. Red/Blue 공수전이며 총 10라운드, 5라운드 뒤 공수 교대. 공격팀은 A/B 지점에서 4초간 자동 설치, 설치 후 35초 뒤 폭발. 수비팀은 폭탄 근처에서 5초간 자동 해체한다. 부활은 없다. 한 팀이 전멸하면 즉시 상대 팀이 라운드를 가져간다.
